...
export const ADD_SCHOOL_STUDENTS_BULK_API_URL = `${SERVER_URL}/team88/bulk_create/`
export const EXPORT_SCHOOL_STUDENTS_BULK_API_URL = `${SERVER_URL}/vr/`
export const ADD_SCHOOL_COORDINATORS_BULK_API_URL = `${SERVER_URL}/visiblerisk/bulk_create/`
export const EXPORT_SCHOOL_COORDINATORS_BULK_API_URL = `${SERVER_URL}/t88/`
