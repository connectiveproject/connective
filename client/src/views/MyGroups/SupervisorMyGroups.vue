...
export default {
  ...
  async beforeRouteEnter(to, from, next) {
    ...
    await store.dispatch("supervisorProgramGroup/getGroupList", {
  ...
  computed: {
    ...mapState("supervisorProgramGroup", ["totalGroups", "groupList"]),
    ...mapState("pagination", ["page"]),
  },
  methods: {
    ...mapActions("pagination", ["incrementPage"]),
    ...mapActions("supervisorProgramGroup", ["getGroupList"]),
    trimText,
    onEndOfPage() {
      this.incrementPage()
    },
