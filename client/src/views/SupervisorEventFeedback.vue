...
export default {
  ...
  async beforeRouteEnter(to, from, next) {
    const event = await store.dispatch("supervisorEvent/getEvent", to.params.slug)
  ...
  methods: {
    ...mapActions("supervisorEvent", ["createEventFeedback"]),
    ...
    async onSubmit() {
      try {
        ...
        this.$router.push({ name: "SupervisorPendingEventsFeedback" })
      } catch (err) {
